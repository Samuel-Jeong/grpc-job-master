package com.telcoware.job_master_app_demo.scheduler.schedule.handler;
...
import com.telcoware.job_master_app_demo.scheduler.schedule.unit.JobAdder;
...
public class JobScheduler {
    ...
    public boolean schedule(Job job) {
        ...
        scheduleLock.lock();
        try {
            if (!job.isCron() && job.isLasted() && job.getInterval() <= 0) {
