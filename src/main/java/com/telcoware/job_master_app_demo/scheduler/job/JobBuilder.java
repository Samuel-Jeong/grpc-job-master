...
import com.telcoware.job_master_app_demo.scheduler.schedule.handler.callback.JobFinishCallBack;
...
public class JobBuilder {
    ...
    // --- CRON helpers ---
    public JobBuilder setCronExpression(String cronExpression) {
        job.setCronExpression(cronExpression);
        return this;
    }

    public JobBuilder setTimeZone(TimeZone timeZone) {
        job.setTimeZone(timeZone);
        return this;
    }

    public JobBuilder useCron(String cronExpression, TimeZone timeZone) {
        job.useCron(cronExpression, timeZone);
        return this;
    }
