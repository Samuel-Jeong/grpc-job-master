package com.dovaj.job_master_app_demo.controller;

import com.dovaj.job_master_app_demo.data.dto.job.JobInfoDto;
import com.dovaj.job_master_app_demo.job.dto.impl.AddJobInfo;
import com.dovaj.job_master_app_demo.job.dto.impl.StopJobInfo;
...
import com.dovaj.job_master_app_demo.message.dto.DefaultResultDto;
import com.dovaj.job_master_app_demo.message.request.GrpcAddWorkReqDto;
import com.dovaj.job_master_app_demo.message.request.GrpcStopWorkReqDto;
import com.dovaj.job_master_app_demo.message.response.GrpcAddWorkResDto;
import com.dovaj.job_master_app_demo.service.grpc.GrpcClientService;
import com.dovaj.job_master_app_demo.util.SnowflakeIdUtil;
...
import static com.dovaj.job_master_app_demo.data.definition.STRING_CONSTANTS.JOB_PREFIX;

/**
 * packageName    : com.dovaj.job_master_app_demo.controller
